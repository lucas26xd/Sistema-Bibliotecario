...
CREATE TABLE IF NOT EXISTS `equipe378981`.`livros` (
  ...
  PRIMARY KEY (`isbn`),
  INDEX `fk_livros_categorias1_idx` (`codigo_categoria` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `equipe378981`.`usuarios` (
  ...
  UNIQUE INDEX `endereço_UNIQUE` (`endereco` ASC) VISIBLE,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `equipe378981`.`alunos` (
  ...
  INDEX `fk_alunos_curso1_idx` (`cod_curso` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `equipe378981`.`professores` (
  ...
  `cod_curso` INT NOT NULL,
  `id_usuario` INT NOT NULL,
  INDEX `fk_professsores_curso1_idx` (`cod_curso` ASC) VISIBLE,
  UNIQUE INDEX `mat_siape_UNIQUE` (`mat_siape` ASC) VISIBLE,
  PRIMARY KEY (`id_usuario`),
...
CREATE TABLE IF NOT EXISTS `equipe378981`.`telefones_funcionarios` (
  ...
  INDEX `fk_telefones_funcionarios_funcionarios1_idx` (`id_funcionario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `equipe378981`.`telefones_alunos` (
  ...
  INDEX `fk_telefones_alunos_alunos1_idx` (`id_aluno` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `equipe378981`.`livros_tem_autores` (
  ...
  INDEX `fk_autores_has_livros_livros1_idx` (`isbn_livro` ASC) VISIBLE,
  INDEX `fk_autores_has_livros_autores1_idx` (`CPF_autor` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `equipe378981`.`emprestimo` (
  ...
  INDEX `fk_usuarios_has_livros_livros1_idx` (`isbn_livro` ASC) VISIBLE,
  INDEX `fk_reserva_usuarios1_idx` (`usuarios_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `equipe378981`.`reserva` (
  ...
  PRIMARY KEY (`usuarios_id`, `isbn_livro`, `data`),
  INDEX `fk_usuarios_has_livros_livros2_idx` (`isbn_livro` ASC) VISIBLE,
...
BEGIN
	IF(NEW.data_conclusao <= CURDATE()) THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = "Erro! Data de conclusao prevista ja foi atingida!";
	END IF;
END;$$
