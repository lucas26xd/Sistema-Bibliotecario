...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `equipe378981`.`viewProfbyCurso` (`*` INT);

-- -----------------------------------------------------
-- Placeholder table for view `equipe378981`.`viewLivrosbyCategoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `equipe378981`.`viewLivrosbyCategoria` (`*` INT);

-- -----------------------------------------------------
-- Placeholder table for view `equipe378981`.`viewLivrosbyEditora`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `equipe378981`.`viewLivrosbyEditora` (`*` INT);

-- -----------------------------------------------------
-- Placeholder table for view `equipe378981`.`viewLivrosbyAno`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `equipe378981`.`viewLivrosbyAno` (`*` INT);

-- -----------------------------------------------------
-- Placeholder table for view `equipe378981`.`viewLivrosbyAutor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `equipe378981`.`viewLivrosbyAutor` (`*` INT);
...
GROUP BY codigo_categoria, isbn, titulo,  ano_lancamento, editora, qtd_copias, codigo, descricao
ORDER BY titulo;
...
SELECT *
FROM (livros JOIN categorias ON codigo_categoria = codigo) 
GROUP BY editora, codigo_categoria, isbn,  ano_lancamento, titulo, qtd_copias, codigo, descricao
ORDER BY titulo;
...
SELECT *
FROM (livros JOIN categorias ON codigo_categoria = codigo) 
GROUP BY ano_lancamento, codigo_categoria, isbn, titulo, editora, qtd_copias, codigo, descricao
ORDER BY titulo;
...
FROM (((livros JOIN categorias ON codigo_categoria = codigo) 
        ...
        JOIN autores ON CPF = CPF_autor) 
GROUP BY nome, codigo_categoria, isbn, titulo,  ano_lancamento, editora, qtd_copias, codigo, descricao, isbn_livro, CPF_autor, CPF, nacionalidade
ORDER BY titulo;
