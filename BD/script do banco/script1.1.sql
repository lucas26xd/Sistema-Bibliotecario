...
START TRANSACTION;
USE `equipe378981`;
INSERT INTO `equipe378981`.`reserva` (`usuarios_id`, `isbn_livro`, `data`, `data_entrega`, `entregue`) VALUES (3, 8673409846112, '2018-03-10', '2018-11-11', DEFAULT);
